...
public class calculadora_operar extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calculadora_operar);
    }

    public void btnCero(View view){
        tvDisplay = (TextView)findViewById(R.id.txt_vis);
